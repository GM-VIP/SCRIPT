...
echo -e "${cor[3]}  INSTALADOR SHADOWSOCK-LIBEV+(obfs)"
msg -bar
...
1)
msg -bar
wget --no-check-certificate -O Instalador-Shadowsocks-libev.sh https://raw.githubusercontent.com/ELITE-MUNDIAL/VIP/main/ArchUt/SHADOWSOCK-LIBEV/Instalador-Shadowsocks-libev.sh > /dev/null 2>&1
