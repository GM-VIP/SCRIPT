...
cd socks
patch="https://raw.githubusercontent.com/ELITE-MUNDIAL/main/ArchUt/backsocz"
arq="backsocz"
...
msg -bar
echo -ne "Digite Un Puerto SSH/DROPBEAR activo: \033[1;37m"
read -p " Elige : " puetoantla 
  msg -bar
echo -e "Respuesta de Encabezado (101, 200, 484, 500, etc) : \033[1;37m"
read -p " Elige : " respo_stat 
...
echo -e "\033[1;32m $(fun_trans  "INSTALADOR SOCKS VPS-GHOST")"
msg -bar
